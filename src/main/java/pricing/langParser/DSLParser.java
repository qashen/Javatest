...
import pricing.dslResolver.DSLKeywordResolver;
import pricing.dslResolver.DSLResolver;
...
public class DSLParser {
    ...
    public DSLParser() {
        this.dslPatternUtil = new DSLPatternUtil();
        this.keywordResolver = new DSLKeywordResolver();
    }
